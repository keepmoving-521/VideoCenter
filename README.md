...
单个影片播放进度查询请参阅
[播放进度查询文档](docs/playback-progress-query.md)。

继续观看与最近观看列表请参阅
[观看记录列表文档](docs/playback-history-lists.md)。

自动判断看完和手动观看状态请参阅
[观看完成状态文档](docs/watch-completion-state.md)。

电视剧最近观看分集与下一集推荐请参阅
[分集观看与推荐文档](docs/recent-and-next-episode.md)。

单条、批量和全部观看历史删除请参阅
[观看历史删除文档](docs/watch-history-deletion.md)。

累计观看时长和每日观看趋势请参阅
[观看时长统计文档](docs/watch-time-statistics.md)。

统一后台任务模型设计请参阅
[统一后台任务模型文档](docs/unified-background-task-model.md)。
...
前端应用壳、导航与响应式布局请参阅
[前端基础布局文档](docs/frontend-base-layout.md)。

前端后端请求、超时和标准错误处理请参阅
[前端 API 请求文档](docs/frontend-api-client.md)。

首页统计、继续观看和任务动态请参阅
[前端首页数据概览文档](docs/frontend-home-dashboard.md)。
